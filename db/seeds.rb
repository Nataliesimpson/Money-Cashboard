...
transaction4 = Transaction.new({'merchant_id' => merchant5.id, 'tag_id' => tag5.id, 'transaction_name' => 'June Salary', 'amount' => 1000, 'debit_credit' => 'credit', 'transaction_date' => '2016-07-03', 'transaction_time' => '09:00'}).save
